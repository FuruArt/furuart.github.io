...
Czas dowalić składników, żeby całość zaczęła jakoś wyglądać. Tak jak w dwóch poprzednich lekcjach [#1]({% post_url 2016-10-12-cino-1 %}) oraz [#2]({% 2016-10-15-cino-2 %}) dodałem pierw `Normalize.css` oraz Font i ikonki od [Ionicons](http://ionicons.com/)
